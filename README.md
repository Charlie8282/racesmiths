...
**Club Manager Actions**
 ...
 As the *CM* clicks to create a Championship they will be met with multiple options to customize it.  This is the basic run down of creating a Championship from the start.
have to then select a points system, which will be the Number of points for first place and how the points will decend from there.  Then a bonus section where the *CM* can add any desired bonus points for any given Race/Heat/Event to each of the following presets.  Also included will be the option to add a blank input to your scorecard, marked as bonus for custom bonus points to be added however the *CM* wishes to.  If you don't plan to have any bonus points you can just skip this section.  Points deduction system
